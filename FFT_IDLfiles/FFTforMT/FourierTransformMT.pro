...
set_plot, "ps";
device, filename = "/Users/varunkapoor/Documents/Ines_Fourier/FFT_Varun_Exp1All/test.ps", /color, bits=8;
...
plot, frequ,finalspecaverage, xrange=[fromenerg,toenerg], xtickinterval = 0.04  , xstyle=1, ystyle=1, /ylog, xtitle = "Frequency (hours)", ytitle = "Amplitude", title = "Averaged Result Exp1", XTickFormat='WaveNumberFormat';;, yrange = [1.0E-3, 1.0]
